...
const sendDemoAuth = (res, message) => {
...
export const Signup = async (req, res) => {
  if (isDemoMode) {
    return sendDemoAuth(res, "Demo signup successful");
  }
...
export const Login = async (req, res) => {
  if (isDemoMode) {
    return sendDemoAuth(res, "Demo login successful");
  }
  ...
  export const getUser = async(req, res) =>{
    if (isDemoMode) {
      return res.json([demoStore.user]);
    }
